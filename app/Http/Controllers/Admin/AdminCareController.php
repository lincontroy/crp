...
class AdminCareController extends Controller
{
    ...
    public function sendEmail(Request $request) {
        ...
        try{
            ...
            return back()->with(['error' => ["Oops! Failed to send mail. Please recheck your mail credentials or reconfigure mail"]]);
        }
    ...
    public function store(Request $request)
    {
        ...
        if ($request->hasFile("image")) {
            try {
                ...
                return back()->with(['error' => ['Oops! Failed to upload image.']]);
            }
        }
    ...
    public function roleUpdate(Request $request)
    {
        ...
        if (!$role) {
            return back()->with(['error' => "Oops! Target role not found!"]);
        }
