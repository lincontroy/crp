                    ...
                    <div class="py-3">
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <h4 class="exchange-rate">
                                ...
                                {{ get_amount($transaction->exchange_rate, $transaction->gateway_currency->currency_code,"double") }}
                            </h4>
                        </div>
                        <hr>
                        <div class="d-flex justify-content-between">
                            <h4>{{ __("Fees_WEB") }}</h4>
                            <h4 class="fees">{{ get_amount($transaction->total_charge, $transaction->creator_wallet->currency->code) }}</h4>
                        </div>
                        <hr>
                        <div class="d-flex justify-content-between">
