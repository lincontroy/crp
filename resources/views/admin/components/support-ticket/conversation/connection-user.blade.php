        ...
        @if ($basic_settings->broadcast_config != null && $basic_settings->broadcast_config->method == "pusher")
            ...
            <script>
                ...
                channel.bind('support-conversation', function(data) {
                    ...
                    var addClass = "justify-content-start";
                    var userImage = "";
                    var adminImage = "";
                    var bodyClass = "";
                    var userSMSClass = "";
                    if(data.conversation.sender_type == "USER") {
                        ...
                        userImage = `<img class="img" src="${data.conversation.senderImage}" alt="client">`;
                        userSMSClass = "justify-content-end";
                    }else {
                        bodyClass = "recive";
                        adminImage = `<img class="img" src="${data.conversation.senderImage}" alt="client">`;
                    }

                    var chatBlock = `
                        <div class="d-grid ${addClass} col-12">
                            <div class="d-flex ${userSMSClass}">
                                ${adminImage}
                                <div class="chat-body ${bodyClass} ps-3">
                    ...
                    $(".support-chat-area .messages").append(chatBlock);
                });
